...
export const translations = {
      ...
      education: [
        {
          ...
          period: "2017 - 2021",
          activities: "PBL - Análise de aplicativos de batimentos cardíacos, Sensor de estacionamento"
        },
        {
          school: "SENAI",
  ...
  en: {
    ...
    profile: {
      ...
      industry: "IT Services and IT Consulting",
      github: "KauamCosta",
      summary: "Strong communication skills and interpersonal relationships, with excellent teamwork abilities. Available morning and afternoon. Passionate about technology, always seeking to learn new things. I've been interested in the IT field since I was young, thus developing a strong affinity with technology.",
      experience: [
        {
          company: "MJV Technology & Innovation",
      ...
      education: [
        {
          ...
          period: "2017 - 2021",
          activities: "PBL - Analysis of heart rate applications, Parking sensor"
        },
        {
          school: "SENAI",
      ...
      publications: [
        {
          ...
          publisher: "Editora Pascal",
          date: "Sep 10, 2020",
          description: "Participation in Chapter 12 of the book, presenting a compilation of projects from different engineering fields.",
          link: "https://editorapascal.com.br/2020/09/10/livro-engenharia-multidisciplinar-vol-02/"
        },
        {
          title: "Memory Game to Aid People with Memory Difficulties or Alzheimer's",
          publisher: "CONTECC 2019",
          date: "Jul 2, 2019",
          description: "This article presents a project developed as a Problem-Based Learning (PBL) project in the fourth semester of the Computer Engineering course at UNINTER. It consists of prototyping a device based on the Genius game, which tests the player's cognitive abilities, to be used as an aid in treating memory dysfunctions or Alzheimer's. The system developed is based on the Arduino platform and reproduces the operation of the Genius game, with modifications that include a new mechanical design and a display for showing messages. The results present tests of the built prototype indicating the possibility of its use for memorization exercises.",
          link: "https://drive.google.com/file/d/0B4urygqFd5wKZzFObzYzbjVsMlpBby1ERWlGTFNDaW1sZ0lZ/view?resourcekey=0-lqXpDjMlvgX8_2Bx7lEGLA"
        }
      ]
    }
